...
public class Cat
{
    ...
    public static int getCatCount()
    {
        ...
        int catCount = Cat.catCount; // берет статическую переменную
        return catCount;             // возвращает статическую переменную
    }

    public static void setCatCount(int catCount)
    {
        //напишите тут ваш код
        Cat.catCount = catCount;  // изменяет статическую переменную
